    ...
    <v-tabs v-model="tab">
      ...
      <v-tabs-items v-model="tab">
        ...
        <v-tab-item>
          <div class="image_blocks mt-2 mr-2 mb-2">
            <div
              ...
              :class="{
                ...
                warning: img.qc !== undefined && img.qc.warnings.length && !img.qc.errors.length,
          ...
          <image-header :img="selected_img" v-if="selected_img" :qc_keys="series.series.qc.qc_keys"></image-header>
        </v-tab-item>
        <v-tab-item>
          <v-timeline>
