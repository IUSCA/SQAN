    ...
    <v-list-item two-line>
      ...
      <v-list-item-content>
        ...
        <div class="errordesc" v-if="error.type == 'image_count_mismatch' && error.c >= error.tc">
          <v-list-item-title>{{error.c - error.tc}} excess image headers </v-list-item-title>
          <v-list-item-subtitle>The template for this series contains {{error.tc}} images, but {{error.c}} images were found</v-list-item-subtitle>
        </div>
