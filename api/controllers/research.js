...
router.get('/canqc/:research_id', jwt({secret: config.express.jwt.pub, algorithms: ['RS256']}), function(req, res, next) {
...
//rerun QC
router.post('/reqc/:mode/:research_id', jwt({secret: config.express.jwt.pub, algorithms: ['RS256']}), function(req, res, next) {
...
router.get('/:id', jwt({secret: config.express.jwt.pub, algorithms: ['RS256']}), function(req, res, next) {
