...
//get single keyword
router.get('/:qckeyword', jwt({secret: config.express.jwt.pub, algorithms: ['RS256']}), common.has_role("admin"), function(req, res, next) {
...
//single update
router.patch('/update/:id', jwt({secret: config.express.jwt.pub, algorithms: ['RS256']}), common.has_role("admin"), function(req, res, next) {
...
//bulk update
router.patch('/', jwt({secret: config.express.jwt.pub, algorithms: ['RS256']}), common.has_role("admin"), function(req, res, next) {
